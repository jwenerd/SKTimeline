...
var formatEntityData = function formatEntityData(ent_counts) {
...
(function (ent_counts) {
  ...
  var treemap = d3.treemap().tile(d3.treemapResquarify).size([width, height]).round(true).paddingInner(1);

  var root = d3.hierarchy(treedata).eachBefore(function (d) {
  ...
  d3.selectAll("input[name='mode']").data([sumBySize, sumByCount], function (d) {
